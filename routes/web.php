...
Route::middleware(['auth', 'role:SUPER_ADMIN,ADMIN,DEVELOPER', 'log.activity'])->prefix('admin')->group(function () {
    ...
    Route::get('/laporan-rat-retail', \App\Livewire\Admin\RatRetailReport::class)->name('admin.rat-retail-report');
...
Route::middleware(['auth', 'member.type'])->prefix('member')->name('member.')->group(function () {
    ...
    Route::get('/transfer', \App\Livewire\Member\Transfer::class)->middleware('member.active')->name('transfer');
