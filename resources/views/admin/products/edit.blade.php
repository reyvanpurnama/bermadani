            ...
            <div class="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div x-data="{
                        ...
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Stok Saat Ini <span
                                class="text-rose-500">*</span></label>
                        ...
                        @error('stock')
                            <p class="text-xs text-rose-500 mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-slate-400 mt-1">Perubahan stok akan dicatat sebagai penyesuaian manual</p>
                    </div>
