...
<div class="max-w-3xl">
    ...
    {{-- Form --}}
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="bg-white dark:bg-darkCard rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 p-6 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="sellPrice" value="{{ old('sellPrice', $product->sellPrice) }}" required min="0" step="100"
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 text-sm">Rp</span>
                        <input type="number" name="buyPrice" value="{{ old('buyPrice', $product->buyPrice) }}" min="0" step="100"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Stok Saat Ini <span class="text-rose-500">*</span></label>
                ...
                <div>
                    ...
                    <input type="number" name="threshold" value="{{ old('threshold', $product->threshold) }}" required min="1"
