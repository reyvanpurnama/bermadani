...
<div class="max-w-xl mx-auto pb-24 lg:pb-0">
    ...
    <div class="text-center pt-8 animate-[fadeIn_0.5s_ease-out]">
        ...
        <div class="flex gap-4">
            <a href="{{ route('member.dashboard') }}" class="flex-1 py-4 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                Ke Beranda
            </a>
