<div class="px-4 py-6 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">Laporan Rapat Anggota Tahunan (RAT)</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Ringkasan keuangan dan pencapaian koperasi tahun berjalan.</p>
        </div>
        <div>
            <button onclick="window.print()" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
- Kol. Lancar: {{ $pinjaman['lancar_count'] }} Anggota (Sisa Peringatan: Rp {{ number_format($pinjaman['lancar_rp'], 0, ',', '.') }})
