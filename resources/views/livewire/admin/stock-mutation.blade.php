<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-darkCard p-4 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col md:flex-row gap-4 justify-between items-end md:items-center">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.stock-adjustment') }}" class="bg-white dark:bg-darkCard border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 px-4 py-2 rounded-lg text-[12px] font-bold flex items-center gap-2 transition-colors whitespace-nowrap">
                <i class='bx bx-slider-alt'></i> Stock Opname
            </a>
