<div x-data="{ 
    ...
    <div class="max-w-xl mx-auto pb-24 lg:pb-0">
        ...
        <div
            ...
            <div
                class="absolute top-0 left-0 w-full h-24 bg-gradient-to-r from-primary/10 to-indigo-500/10 dark:from-primary/20 dark:to-indigo-500/20">
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="text-center py-6">
                <p class="text-[10px] text-slate-400">BERMADANI v1.0.0 • Retail Portal</p>
            </div>
        </div>
    </div>
