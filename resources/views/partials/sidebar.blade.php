        ...
        @else
            ...
            <div x-show="workspace === 'retail'" x-transition:enter="transition ease-out duration-200"
                ...
                <a href="{{ route('admin.product-approvals') }}"
                    class="nav-item flex items-center px-2 py-1.5 rounded-md transition-all group whitespace-nowrap {{ request()->routeIs('admin.product-approvals') ? 'bg-indigo-50 dark:bg-indigo-500/10 text-primary dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}">
                    <i
                        class='bx bx-archive-in text-sm mr-2 {{ request()->routeIs('admin.product-approvals') ? 'opacity-100' : 'opacity-70 group-hover:opacity-100' }} transition-opacity shrink-0'></i>
                    <span
                        class="sidebar-text text-xs {{ request()->routeIs('admin.product-approvals') ? 'font-semibold' : 'font-medium' }} transition-opacity duration-300">Pengajuan
                        Produk</span>
                </a>
                <a href="#"
