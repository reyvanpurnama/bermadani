# PROMPT INFOGRAFIS LEMBAR 2: LAPORAN POSISI KEUANGAN (NERACA) & EKUITAS
...
```text
Buatkan lembar infografis kedua berukuran A4 Portrait yang menyajikan "Laporan Posisi Keuangan (Neraca) dan Perubahan Ekuitas" Koperasi Bermadani (Khusus Data Anggota Aktif).
