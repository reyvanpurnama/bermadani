# PROMPT INFOGRAFIS LEMBAR 2: LAPORAN POSISI KEUANGAN (NERACA KHUSUS BERMADANI)
...
```text
Buatkan lembar infografis kedua berukuran A4 Portrait yang menyajikan "Laporan Posisi Keuangan (Neraca Khusus Internal Bermadani)" Koperasi Bermadani (Khusus Data Anggota Aktif).
...
- Judul: "LAPORAN POSISI KEUANGAN (NERACA KHUSUS BERMADANI)"
- Periode: "Per 31 Desember 2025 (Fokus 113 Anggota Aktif)"

[SECTION 1: TABEL LAPORAN POSISI KEUANGAN (NERACA KHUSUS BERMADANI)]
Layout Dua Kolom Seimbang (Side-by-Side Table):

KOLOM KIRI: ASET KOPERASI BERMADANI (AKTIVA REAL)
------------------------------------------------------
- ASET FISIK & PINJAMAN BERMADANI:
  * 1. Kas & Bank (Saldo Akhir CSV Line 28) : Rp  30.499.118
  * 2. Aset Tetap & Inventaris (CSV Line 13): Rp  11.021.000
  * 3. Piutang Pinjaman Bermadani (Real DB) : Rp   1.233.333
------------------------------------------------------
- TOTAL ASET REAL BERMADANI (AKTIVA)        : Rp  42.753.451
...
---------------------------------------------------------------------------------------------
URAIAN                  | SIMPANAN POKOK | SIMPANAN WAJIB | SIMPANAN SUKARELA | TOTAL SIMPANAN
---------------------------------------------------------------------------------------------
...
- Disetujui oleh: Rapat Anggota Tahunan (RAT) 2025 • Ketua: Ridlo Abdillah
```
