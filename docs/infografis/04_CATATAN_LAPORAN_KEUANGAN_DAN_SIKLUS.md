# PROMPT INFOGRAFIS LEMBAR 4: SIKLUS AKUNTANSI, ARUS KAS & CATATAN PENTING (CALK)
**Ukuran Kertas**: A4 Portrait (Ratio 1:1.414)
**Desain & Tema**: Process Flowchart & Informative Corporate Style, Clean Layout, Emerald Accent.
...
[1. Transaksi Koperasi] ➔ [2. Jurnal Umum] ➔ [3. Buku Besar] ➔ [4. Neraca Saldo] ➔ [5. Laporan Keuangan & RAT]
- Keterangan: "Seluruh transaksi keuangan dicatat secara digital, terintegrasi, dan terverifikasi dalam sistem pembukuan resmi Koperasi Bermadani."

[SECTION 2: RINGKASAN ARUS KAS (CASH FLOW STATEMENT 2025)]
Grid 3 Aktivitas Arus Kas:
1. ARUS KAS AKTIVITAS OPERASIONAL:
   - Penerimaan dari Anggota & Usaha : Rp 168.049.500
   - Pembayaran Pengeluaran Operasional : (Rp 137.550.382)
   - Kas Bersih Aktivitas Operasional : Rp  30.499.118

2. ARUS KAS AKTIVITAS INVESTASI:
   - Pembelian Aset / Penguatan Unit Usaha : Rp 0
   - Kas Bersih Aktivitas Investasi : Rp 0

3. ARUS KAS AKTIVITAS PENDANAAN:
   - Pembagian SHU & Pencairan : (Sesuai Keputusan RAT)
   - Kas Bersih Aktivitas Pendanaan : Rp 0
...
---------------------------------------------------------------------------------------------
Disusun Oleh (Pengurus Koperasi):          Disetujui Oleh (Peserta RAT 2025):

( Ridlo Abdillah )                         ( Perwakilan Anggota RAT )
Ketua Koperasi Bermadani                   Tanggal: 31 Juli 2026
---------------------------------------------------------------------------------------------
```
