...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.supplier.driver' => 'string',
            'auth.guards.supplier.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.suppliers.driver' => 'string',
            'auth.providers.suppliers.model' => 'string',
            ...
            'auth.passwords.suppliers.provider' => 'string',
            'auth.passwords.suppliers.table' => 'string',
            'auth.passwords.suppliers.expire' => 'integer',
            'auth.passwords.suppliers.throttle' => 'integer',
            ...
            'filesystems.links.C:\Users\Aegner\OneDrive\Documents\Aeg Project\koperasiumb_laravel\koperasi-umb\public\storage' => 'string',
...
'auth.guards.web.provider','auth.guards.supplier.driver','auth.guards.supplier.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.suppliers.driver','auth.providers.suppliers.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
'auth.passwords.users.throttle','auth.passwords.suppliers.provider','auth.passwords.suppliers.table','auth.passwords.suppliers.expire','auth.passwords.suppliers.throttle',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Aegner\\OneDrive\\Documents\\Aeg Project\\koperasiumb_laravel\\koperasi-umb\\public\\storage',
...
'livewire.smart_wire_keys','livewire.pagination_theme','livewire.release_token','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'signed','throttle','verified','role','supplier.status',
'cashier.shift','log.activity','member.type',);
        registerArgumentsSet('routes', 
'livewire.update','livewire.upload-file','livewire.preview-file','home','supplier.register','supplier.register.store','login','logout','supplier.pending','supplier.dashboard','supplier.products.index',
'supplier.products.create','supplier.products.store','supplier.products.edit','supplier.products.update','supplier.products.destroy',
'supplier.sales','supplier.restock','supplier.profile','supplier.notifications','supplier.notifications.mark-read',
'supplier.notifications.mark-all-read','admin.dashboard','admin.pos','admin.products','admin.products.create',
'admin.restock-requests','admin.products.store','admin.stock-mutation','admin.stock-adjustment','admin.product-review',
'admin.products.edit','admin.products.update','admin.products.destroy','admin.consignment-batches','admin.consignment-report',
'admin.categories','admin.transactions','admin.manual-transaction','admin.manual-transaction.history','admin.manual-transaction.detail',
'transaksi.detail','admin.members.index','admin.members.create','admin.members.show','admin.members.edit',
'admin.members.simpanan','admin.retail-members.index','admin.retail-members.show','admin.savings','admin.audit.simwa',
'admin.payments.create','admin.payments.receipt','admin.loans','admin.loans.import','admin.users',
'admin.suppliers','admin.suppliers.detail','admin.suppliers.verifyPayment','admin.suppliers.rejectPayment','admin.suppliers.approve',
'admin.suppliers.reject','admin.suppliers.suspend','admin.suppliers.activate','admin.settings','admin.activity-logs',
'admin.kasir-history','admin.reports.monthly-financial','admin.reports.balance-sheet','admin.developer-payroll','developer.work-logs',
'transaction.receipt','kasir.dashboard','kasir.pos','kasir.transactions','kasir.transaction.detail','member.dashboard','member.profile','member.simpanan','member.transactions',
'member.transfer','member.transfer.history','membership.dashboard','membership.history','membership.profile',
'membership.simpanan','membership.transfer','membership.','storage.local',);
        registerArgumentsSet('views', 
'admin.activity-logs','admin.categories.index','admin.dashboard','admin.manual-transaction','admin.manual-transaction-detail',
'admin.manual-transaction-history','admin.members.create','admin.members.edit','admin.members.index','admin.members.show',
'admin.members.simpanan','admin.placeholder','admin.pos','admin.product-approvals','admin.products.create',
'admin.products.edit','admin.products.index','admin.reports.developer-payroll-pdf','admin.reports.monthly-financial-pdf','admin.reports.payroll-simple-pdf',
'admin.suppliers.detail','admin.suppliers.index','admin.transactions.detail','admin.transactions.index','admin.users.index',
'auth.login','filament.pages.p-o-s-page','filament.pages.point-of-sale','kasir.dashboard','landing',
'layouts.admin','layouts.member','layouts.membership','layouts.supplier','livewire.activity-logs',
'livewire.admin.consignment-batches','livewire.admin.consignment-report','livewire.admin.developer-payroll','livewire.admin.kasir-history','livewire.admin.loan-import',
'livewire.admin.member-create','livewire.admin.member-detail','livewire.admin.member-edit','livewire.admin.member-management','livewire.admin.monthly-debit-approval',
'livewire.admin.monthly-financial-report','livewire.admin.payment-form','livewire.admin.payment-receipt','livewire.admin.product-review','livewire.admin.reports.balance-sheet',
'livewire.admin.restock-management','livewire.admin.retail-member-detail','livewire.admin.retail-member-management','livewire.admin.simpanan-management','livewire.admin.simwa-audit-tool',
'livewire.admin.stock-adjustment','livewire.admin.stock-mutation','livewire.admin.supplier-management','livewire.categories','livewire.components.member-search-select',
'livewire.dashboard','livewire.developer.work-log-manager','livewire.kasir.dashboard','livewire.manual-transaction','livewire.manual-transaction-detail',
'livewire.manual-transaction-history','livewire.member.dashboard','livewire.member.profile','livewire.member.simpanan','livewire.member.transactions',
'livewire.member.transfer','livewire.member.transfer-history','livewire.membership.dashboard','livewire.membership.history','livewire.membership.profile',
'livewire.membership.simpanan','livewire.membership.transfer','livewire.pos-custom','livewire.products','livewire.transactions',
'livewire.user-management','member.dashboard','member.profile','member.transactions.index','member.transactions.show',
'partials.member-sidebar','partials.mobile-bottom-nav','partials.sidebar','partials.sidebar-old','partials.supplier-mobile-nav',
'pos.index','supplier.dashboard','supplier.notifications','supplier.pending','supplier.products.create',
'supplier.products.edit','supplier.products.index','supplier.profile','supplier.register','supplier.restock',
'supplier.sales','transactions.receipt','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.Aegner.OneDrive.Documents.Aeg Project.koperasiumb_laravel.koperasi-umb.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
