...
class MemberKoperasi extends Member
{
    ...
    protected static function booted()
    {
        ...
        static::created(function ($memberKoperasi) {
            // Auto-create Member Minimarket untuk Member Koperasi
            if ($memberKoperasi->userId && !MemberMinimarket::where('userId', $memberKoperasi->userId)->exists()) {
                MemberMinimarket::create([
                    'userId' => $memberKoperasi->userId,
                    'memberNumber' => self::generateMemberNumberMinimarket(),
                    'cardNumber' => self::generateCardBarcode(),
                    'points' => 0,
                    'totalSpent' => 0,
                    'status' => 'ACTIVE',
