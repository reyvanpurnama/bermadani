...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Relation::enforceMorphMap([
            ...
            'user_legacy'           => \App\Models\User::class,
            'activity_log'          => \App\Shared\Models\ActivityLog::class,
            'activity_log_legacy'   => \App\Models\ActivityLog::class,
            // Koperasi
            'member'                => \App\Domains\Koperasi\Models\Member::class,
            'member_legacy'         => \App\Models\Member::class,
            ...
            'supplier_legacy'       => \App\Models\Supplier::class,
